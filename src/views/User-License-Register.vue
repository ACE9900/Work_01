            ...
            <v-container>
              ...
              <v-card-title class="d-block mt-2 pa-2 grey lighten-1 black--text">
                <v-row class="mx-1 justify-space-between">
                  ...
                  <v-btn text small class="primary" @click="carDialog = !carDialog">
              ...
              <v-card-title class="d-block mt-2 pa-2 grey lighten-1 black--text">
                <v-row class="mx-1 justify-space-between">
                  ...
                  <v-btn text small class="primary" @click="docDialog = !docDialog">
                    <v-icon>mdi-plus-circle-outline</v-icon>
                  </v-btn>
                </v-row>
              </v-card-title>
    ...
    try {
      if (localUser === null || localUser === undefined) {
        ...
        if (localUser.type === "company") {
          ...
          axios
            .get(
              `https://us-central1-laos-single-window.cloudfunctions.net/function/user/licence/register/${username}`
            )
            .then(async res => {
    ...
    async submit() {
      ...
      const data = {
        app_data: {
          ...
          app_ministry_licence: null,
          app_taxoffice_id: null,
          app_department_licence: null,
          app_detail_date_approve: null,
          app_date_expire: null,
          app_extra_time: null,
      ...
      await axios
        .post(
          "https://us-central1-laos-single-window.cloudfunctions.net/function/user/licence/register",
          data
        )
        .then(async res => {
          console.log(res)
